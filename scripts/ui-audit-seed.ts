...
function dynamicFixtures() {
  const one = (pattern: string, key: string, value: string) => ({
    id: pattern.replace(/[^a-z0-9]+/gi, '-'),
    pattern,
    params: { [key]: value },
  });
  return [
    one('/agents/autonomous/[id]', 'id', 'scheduling.reminders'),
    one('/agents/builder/[id]', 'id', 'ui-audit-agent-draft'),
    one('/agents/workshop/[id]', 'id', 'ui-audit-workshop'),
    one('/brains/[id]', 'id', UUID.brain),
    one('/channels/[id]', 'id', 'telegram'),
    one('/crm/[contactId]', 'contactId', UUID.contact),
    one('/finances/invoices/[id]', 'id', UUID.invoice),
    one('/flow-editor/[id]', 'id', 'ui-audit-flow'),
    one('/flow-editor/master/[id]', 'id', 'channel-message-reply'),
    one('/flow-editor/skills/[id]', 'id', 'ui-audit-skill'),
    one('/marketplace/agents/[slug]', 'slug', 'ui-audit-marketplace-agent'),
    one('/plugins/[id]', 'id', 'memory-core'),
    one('/sales/[id]', 'id', UUID.order),
    one('/sessions/[sessionKey]/debug', 'sessionKey', 'ui-audit-session'),
    one('/shells/[shellId]', 'shellId', 'ui-audit-shell'),
    one('/socials/campaigns/[campaignId]', 'campaignId', 'ui-audit-campaign'),
    one('/socials/posts/[postId]', 'postId', 'ui-audit-post'),
    one('/stock/entries/[id]', 'id', UUID.stockEntry),
    one('/stock/items/[id]', 'id', UUID.stockItem),
    one('/support/[id]', 'id', UUID.ticket),
    one('/tools/[id]', 'id', 'ui-audit-tool'),
    one('/workforce/agents/[id]', 'id', 'ui-audit-workforce-agent'),
    one('/workforce/issues/[id]', 'id', 'ui-audit-workforce-issue'),
    one('/workforce/portfolios/[id]', 'id', 'ui-audit-workforce-portfolio'),
    one('/workforce/projects/[id]', 'id', 'ui-audit-workforce-project'),
    one('/workforce/projects/[id]/pipelines', 'id', 'ui-audit-workforce-project'),
    one('/book/[slug]', 'slug', 'ui-audit-booking'),
    one(
      '/link/[code]',
      'code',
