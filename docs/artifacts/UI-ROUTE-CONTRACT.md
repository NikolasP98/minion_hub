...
- 138 renderable screens: 128 app screens plus 10 public/auth/onboarding screens.
...
- 8 redirect/proxy endpoints. Redirects have no screenshot or Figma frame.
...
C: 16, D: 23, and E: 10 endpoints, including redirect ownership. This closes
...
and contains Home, Autonomous Agents, every Workshop screen, Cloud, and Terminal.
...
1. Exact filesystem-to-manifest coverage and the 146/138/8/28 totals.
...
The current certified inventory is 146 page endpoints, 352 API handler files,
298 navigation references, and 389 method-specific frontend API calls, with no
