...
<main class="h-full min-h-0 p-3 bg-black/10">
  ...
  {:else if selected}<div class="h-full min-h-0 overflow-hidden rounded-[var(--radius-md)] border border-[var(--hairline)] shadow-2xl"><RemoteTerminal shell={selected} /></div>
