...
// ── Grid & Layout ────────────────────────────────────────────
export { TILE_SIZE, DEFAULT_COLS, DEFAULT_ROWS, MAX_COLS, MAX_ROWS } from './types';
...
export const WANDER_PAUSE_MIN_SEC = 30.0;
...
// ── Matrix Effect ────────────────────────────────────────────
export { MATRIX_EFFECT_DURATION_SEC } from './types';
