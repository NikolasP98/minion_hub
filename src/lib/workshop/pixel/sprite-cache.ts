...
/** Get a cached offscreen canvas rasterization of a sprite at the given zoom level */
...
/** Clear all cached sprite data (zoom caches and outline cache are WeakMap-based, so we only clear zoom level entries) */
export function clearAllSpriteData(): void {
	zoomCaches.clear();
}
