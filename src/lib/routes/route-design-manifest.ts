...
export const ROUTE_DESIGN_MANIFEST: readonly RouteDesignMeta[] = [
  ...
  screen('/scheduling/bookings/[id]/edit', 'Edit booking', 'scheduling-pos', 'form-settings', {
    params: { id: 'booking-detail' },
    states: MUTATING_DETAIL_STATES,
  }),
  ...
  screen('/pos/accounts', 'POS client accounts', 'scheduling-pos', 'collection'),
  screen('/pos/appointments', 'POS appointments', 'scheduling-pos', 'workspace-editor'),
  screen('/pos/appointments/new', 'New appointment', 'scheduling-pos', 'form-settings'),
  ...
  // Platform, sessions, reliability and remote work (19)
