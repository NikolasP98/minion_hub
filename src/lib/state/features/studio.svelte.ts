...
const CONTENT_TYPE_FRAGMENTS: Record<ContentType, string> = {
  'agent-avatar':
    'Generate a circular agent avatar portrait with clean edges suitable for a profile picture, featuring an abstract or stylized character',
  'app-icon':
    'Generate a square app icon with a bold, recognizable silhouette and minimal detail, suitable for small display sizes',
  'banner-hero':
    'Generate a wide hero banner image with dynamic composition, depth, and visual flow from left to right',
  'background-pattern':
    'Generate a seamless tileable background pattern with subtle geometric or organic elements',
  'ui-illustration':
    'Generate a UI illustration or decorative element for a dashboard interface, suitable as an empty-state graphic or feature visual',
  'social-media':
    'Generate a social media asset suitable for Open Graph cards or promotional posts, with strong visual hierarchy',
};
...
const VISUAL_STYLE_FRAGMENTS: Record<VisualStyle, string> = {
  ...
  'pixel-art':
    'in pixel art style with crisp blocky shapes, limited color palette, and retro charm',
  ...
  photorealistic:
    'in photorealistic style with natural textures, accurate lighting, and fine detail',
  glassmorphism:
    'in glassmorphism style with frosted glass panels, blur effects, subtle transparency, and luminous edges',
};
...
const COLOR_MOOD_FRAGMENTS: Record<ColorMood, string> = {
  brand:
    'using the brand color palette: vibrant pink (#e8547a) as primary accent with dark charcoal (#09090b) backgrounds and off-white (#fafafa) highlights',
  ...
  monochrome:
    'using a monochrome palette: shades of gray from near-black (#09090b) to off-white (#fafafa) with no color accents',
  'neon-cyberpunk':
    'using a neon cyberpunk palette: electric blues, hot pinks (#e8547a), acid greens (#22c55e), and deep purple (#a855f7) glowing against jet black',
  'earth-tones':
    'using earth tones: warm browns, muted greens (#10b981), soft terracotta, and stone grays against dark backgrounds',
};
