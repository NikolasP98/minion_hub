...
<Handle type="target" position={Position.Left} id="in" class="!w-3 !h-3 !border-2 !border-[var(--color-danger-border)] !bg-[var(--color-danger-surface)]" />
...
>
  <div class="flex items-center gap-2 mb-1">
    <div class="w-6 h-6 rounded-md bg-[var(--color-danger-surface)] flex items-center justify-center shrink-0">
      <Headset size={12} class="text-[var(--color-danger-fg)]" />
    </div>
  ...
  <div class="text-[length:var(--font-size-telemetry)] text-muted/70">
