...
<div class="px-3 py-3 flex flex-col gap-3">
  <div>
    <span class="text-[length:var(--font-size-caption)] font-medium text-foreground">Owners (claim candidates)</span>
    <DestinationListField value={working} onChange={onDest} />
  </div>
  <label class="flex flex-col gap-1">
    <span class="text-[length:var(--font-size-caption)] font-medium text-foreground">Priority label</span>
  ...
  <label class="flex flex-col gap-1">
    <span class="text-[length:var(--font-size-caption)] font-medium text-foreground">Suggested replies</span>
  ...
  <label class="flex flex-col gap-1">
    <span class="text-[length:var(--font-size-caption)] font-medium text-foreground">Language</span>
    <Select size="sm" class="text-xs bg-bg3 border border-border rounded px-2 py-1 text-foreground"
      value={data.language ?? 'es'} onchange={(next) => set('language', String(next))}>
      <option value="es">Español</option><option value="en">English</option>
    </Select>
  </label>
  <label class="flex flex-col gap-1">
    <span class="text-[length:var(--font-size-caption)] font-medium text-foreground">Closing message (on /end)</span>
  ...
  <label class="flex flex-col gap-1">
    <span class="text-[length:var(--font-size-caption)] font-medium text-foreground">Context for suggestions (system prompt)</span>
    <textarea class="text-xs bg-bg3 border border-border rounded px-2 py-1 text-foreground resize-y min-h-12"
