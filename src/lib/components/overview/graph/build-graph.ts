...
export function buildGraph(input: BuildInput): { nodes: GraphNode[]; edges: GraphEdge[] } {
  ...
  nodes.push({
    ...
    labelColor: C.fg, labelTier: 'primary', labelSize: 10, showLabel: true,
  });
  ...
  buckets.forEach((b, i) => {
    ...
    nodes.push({
      ...
      labelColor: C.fg, labelTier: 'primary', labelSize: 12, showLabel: true,
    });
    ...
    b.skills.forEach((sk, j) => {
      ...
      nodes.push({
        ...
        symbolSize: 16, labelColor: C.dim, labelTier: 'secondary', labelSize: 9, showLabel: true,
      });
    ...
    b.integrations.forEach((ik, j) => {
      ...
      nodes.push({
        ...
        labelColor: C.dim, labelTier: 'secondary', labelSize: 9, showLabel: false,
      });
    });
    ...
    b.realAgents.forEach((a, j) => {
      ...
      nodes.push({
        ...
        labelColor: '#e4e4e7', labelTier: 'primary', labelSize: 10, showLabel: true,
      });
    ...
    b.virtualAgents.forEach((va, j) => {
      ...
      nodes.push({
        ...
        labelColor: C.dim, labelTier: 'secondary', labelSize: 9.5, showLabel: true,
      });
    ...
    b.users.forEach((u, j) => {
      ...
      nodes.push({
        ...
        labelColor: C.dim, labelTier: 'secondary', labelSize: 10, showLabel: true,
      });
  ...
  serviceMembers.forEach((sa, j) => {
    ...
    nodes.push({
      ...
      labelColor: C.dim, labelTier: 'secondary', labelSize: 10.5, showLabel: true,
    });
