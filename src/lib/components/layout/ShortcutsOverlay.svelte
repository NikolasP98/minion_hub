...
{#if open}
    ...
    <div
        class="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-start justify-center pt-[10vh]"
        data-backdrop
        onclick={handleBackdropClick}
    >
        <div
            class="w-full max-w-lg max-h-[75vh] flex flex-col bg-bg2 border border-border rounded-xl shadow-2xl overflow-hidden"
