...
import { setRevealIntent, settleRevealTransition, type RevealGate } from './dynamic-island-reveal';
...
describe('DynamicIsland reveal gate', () => {
  ...
  it('enables immediately under reduced motion without bypassing close grace', () => {
