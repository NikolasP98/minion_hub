...
<div class="surface-2 relative rounded-lg min-w-40 p-0 overflow-hidden flex transition-shadow duration-300 hover:shadow-[0_0_12px_var(--color-accent)]/10" style:--kpi-color="var({color})">
