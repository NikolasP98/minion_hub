...
<div
    class="absolute z-30 pointer-events-auto -translate-x-1/2 flex items-center gap-0.5 p-0.5 rounded-lg border border-border bg-bg2/95 backdrop-blur shadow-lg"
...
>
    ...
    <button
        ...
        class="w-7 h-7 flex items-center justify-center rounded text-muted hover:text-red-400 hover:bg-red-500/10 transition-colors"
    >
        <Trash2 size={14} />
    </button>
</div>
