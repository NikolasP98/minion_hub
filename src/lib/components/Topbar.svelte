...
<header class="shrink-0 relative z-100 bg-bg/95 backdrop-blur-sm border-b border-border px-4.5 py-2.5 flex items-center gap-2.5">
  ...
  <a href="/reliability" class="text-xs no-underline px-3 py-1 rounded-full border transition-all duration-150 {isReliability ? 'bg-accent/10 text-accent border-accent/30' : 'text-muted border-border hover:bg-bg3 hover:text-foreground'}">{m.nav_reliability()}</a>
  <a href="/config" class="text-xs no-underline px-3 py-1 rounded-full border transition-all duration-150 {isConfig ? 'bg-accent/10 text-accent border-accent/30' : 'text-muted border-border hover:bg-bg3 hover:text-foreground'}">{m.nav_config()}</a>

  <div class="w-px h-4 bg-border/60 mx-1 shrink-0"></div>
  ...
  <a href="/settings" class="text-xs no-underline px-3 py-1 rounded-full border transition-all duration-150 {isSettings ? 'bg-accent/10 text-accent border-accent/30' : 'text-muted border-border hover:bg-bg3 hover:text-foreground'}">{m.nav_settings()}</a>
