...
// decision. This run's harness contract is Hub-repo-only, so it could not make
// that cross-repo edit; the file is readable (and confirmed still lacking the
// append) via `gh api repos/NikolasP98/minion-meta/contents/proposals/\
// 2026-08-17-hub-igv-rate-from-org-config.md?ref=dev`.
